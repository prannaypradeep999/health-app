      ...
      if (todaysMeals) {
        ...
        return {
          breakfast: todaysMeals.breakfast ? [
            ...
            ...(todaysMeals.breakfast.alternatives || []),
            ...(todaysMeals.breakfast.extraRestaurantOptions || [])
          ].filter(Boolean) : [],
          lunch: todaysMeals.lunch ? [
            todaysMeals.lunch.primary,
            ...(todaysMeals.lunch.alternatives || []),
            ...(todaysMeals.lunch.extraRestaurantOptions || [])
          ].filter(Boolean) : [],
          dinner: todaysMeals.dinner ? [
            todaysMeals.dinner.primary,
            ...(todaysMeals.dinner.alternatives || []),
            ...(todaysMeals.dinner.extraRestaurantOptions || [])
          ].filter(Boolean) : []
        };
      }
    }
